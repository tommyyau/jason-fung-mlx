...
def main():
    ...
    for batch_idx in range(num_batches):
        ...
        print(f"  [{examples_done}/{len(validation_examples)}] ({examples_done/len(validation_examples)*100:.1f}%) | "
              f"Elapsed: {elapsed/60:.1f}m | Remaining: ~{remaining/60:.1f}m | Avg: {avg_time:.1f}s/ex")
